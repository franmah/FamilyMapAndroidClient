...
public class SettingActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,
    ...
    private LinearLayout mResyncDataLayout;
    ...
    private void initSpinnerWidgets(){
        ...
        ArrayAdapter<CharSequence> lineAdapter = ArrayAdapter.createFromResource(this,
                        R.array.spinner_color_array, android.R.layout.simple_spinner_dropdown_item);
    ...
    /** Logout/Resync layout **/
    private void initTextLayoutWidgets(){
        // The user can click on the layout containing the text views, makes it easier than clicking
        // on a text view.

        mResyncDataLayout = (LinearLayout) findViewById(R.id.resync_data_layout);
        mLogoutLayout = (LinearLayout) findViewById(R.id.logout_layout);

        mResyncDataLayout.setOnClickListener(this);
    ...
    private class ReSyncData extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String response){
            if(response != null){
                ...
                Log.i(TAG, "RetrieveData, response from DataRetriever came back null, data has been successfully loaded");
                finish();
            }
        }
    }
