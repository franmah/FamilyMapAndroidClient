...
import com.fmahieu.familymap.client.models.*;
...
public class DataRetriever {
    ...
    public String pullData(String hostName, String portNumber){
        ...
        try{
            ...
            String message = getPeople(token);
            if(message != null){
                return message;
            }
    ...
    private String getEvents(String token) {
        ...
        int color = android.R.color.holo_blue_light; // First color in android.R.color
    ...
    private String getPeople(String token){
